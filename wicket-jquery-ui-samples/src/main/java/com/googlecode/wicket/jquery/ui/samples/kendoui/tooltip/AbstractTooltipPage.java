...
abstract class AbstractTooltipPage extends KendoSamplePage
{
	...
	{
		return Arrays.asList(new DemoLink(DefaultKendoTooltipPage.class, "Tooltip Behavior, using strings"), new DemoLink(ComponentKendoTooltipPage.class, "Tooltip Behavior, using Components"));
	}
}
