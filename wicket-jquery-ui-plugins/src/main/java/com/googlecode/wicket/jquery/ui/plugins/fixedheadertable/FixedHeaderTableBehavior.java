...
public class FixedHeaderTableBehavior extends JQueryBehavior
{
	...
	{
		if (ApplicationJavaScriptLibrarySettings.get() instanceof IFixedHeaderTableLibrarySettings)
		{
			return (IFixedHeaderTableLibrarySettings) ApplicationJavaScriptLibrarySettings.get();
		}
