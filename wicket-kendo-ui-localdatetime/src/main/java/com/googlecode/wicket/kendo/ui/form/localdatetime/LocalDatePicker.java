 ...
 */
public class LocalDatePicker extends LocalTextField<LocalDate>
{
	 ...
	 */
	public LocalDatePicker(String id)
	{
	 ...
	 */
	public LocalDatePicker(String id, Options options)
	{
	 ...
	 */
	public LocalDatePicker(String id, String pattern)
	{
	 ...
	 * @param options the {@link Options}
	 */
	public LocalDatePicker(String id, String pattern, Options options)
	{
	 ...
	 */
	public LocalDatePicker(String id, Locale locale)
	{
	 ...
	 * @param options the {@link Options}
	 */
	public LocalDatePicker(String id, Locale locale, Options options)
	{
	 ...
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model)
	{
	 ...
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model, Options options)
	{
	 ...
	 * @param pattern a <code>SimpleDateFormat</code> pattern
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model, String pattern)
	{
	 ...
	 * @param options {@link Options}
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model, final String pattern, Options options)
	{
		super(id, model, pattern, options, LocalDate.class, new IConverter<LocalDate>() {
			private static final long serialVersionUID = 1L;
	 ...
	 * @param locale the {@link Locale}
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model, Locale locale)
	{
	 ...
	 * @param options the {@link Options}
	 */
	public LocalDatePicker(String id, IModel<LocalDate> model, Locale locale, Options options)
	{
